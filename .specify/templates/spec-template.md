...
- Which approach keeps this behavior simple and avoids tricky special cases?
...
- Document any additional contract or end-to-end tests required for cross-system behavior.

| Business Rule | Unit Test Reference | Integration Test Reference |
|---------------|---------------------|----------------------------|
| [Rule 1] | [test id/path] | [test id/path] |
| [Rule 2] | [test id/path] | [test id/path] |
